...
const HomePage=()=>{
  ...
  useEffect(()=>{
    axios.get('https://koovs-server.vercel.app/shop_women').then((res)=>{
      setWomenData(res.data)
    })
  },[])
  useEffect(()=>{
    axios.get('https://koovs-server.vercel.app/shop_men').then((res)=>{
        setMenData(res.data)
    })
  },[])
  useEffect(()=>{
    axios.get('https://koovs-server.vercel.app/varsity-jackets').then((res)=>{
        setVarsityData(res.data)
    })
  },[])
  useEffect(()=>{
    axios.get('https://koovs-server.vercel.app/artist-collab').then((res)=>{
        setArtistData(res.data)
    })
  },[])
  useEffect(()=>{
    axios.get('https://koovs-server.vercel.app/koovs-women').then((res)=>{
        setKoovsWomenData(res.data)
    })
  },[])
  useEffect(()=>{
    axios.get('https://koovs-server.vercel.app/koovs-men').then((res)=>{
